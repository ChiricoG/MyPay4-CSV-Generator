...
# ── versioni tracciato note (header completo per ciascuna) ───────────────
_TRACCIATO_VERSIONS = {
    "1_0": [
        "IUD","codIuv","tipoIdentificativoUnivoco","codiceIdentificativoUnivoco",
        "anagraficaPagatore","indirizzoPagatore","civicoPagatore","capPagatore",
        "localitaPagatore","provinciaPagatore","nazionePagatore","mailPagatore",
        "dataEsecuzionePagamento","importoDovuto","commissioneCaricoPa",
        "tipoDovuto","tipoVersamento","causaleVersamento",
        "datiSpecificiRiscossione","azione",
    ],
    "1_1": [
        "IUD","codIuv","tipoIdentificativoUnivoco","codiceIdentificativoUnivoco",
        "anagraficaPagatore","indirizzoPagatore","civicoPagatore","capPagatore",
    ...
    "1_2": [
        ...
        "dataEsecuzionePagamento","importoDovuto","commissioneCaricoPa",
        "tipoDovuto","tipoVersamento","causaleVersamento",
        "datiSpecificiRiscossione","bilancio","azione",
    ],
    "1_3": [
        "IUD","codIuv","tipoIdentificativoUnivoco","codiceIdentificativoUnivoco",
        "anagraficaPagatore","indirizzoPagatore","civicoPagatore","capPagatore",
        ...
        "dataEsecuzionePagamento","importoDovuto","commissioneCaricoPa",
        "tipoDovuto","tipoVersamento","causaleVersamento",
        "datiSpecificiRiscossione","bilancio","flgGeneraIuv","azione",
    ],
    "1_4": HEADER,
}
