...
def build_bilancio_xml(capitoli: list[dict]) -> str:
    """Costruisce la stringa XML del bilancio MyPay4."""
    parts = ["<bilancio>"]
    for cap in capitoli:
